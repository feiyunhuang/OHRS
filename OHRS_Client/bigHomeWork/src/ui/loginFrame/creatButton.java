...
public class creatButton {
	JButton button;
	ImageIcon imageIcon[];
	creatListener buttonListener ;
	public creatButton (ImageIcon[] imageIcons,runner runner){
		this.imageIcon = imageIcons;
		buttonListener = new creatListener(runner);
		init();
		look();
	}
	public void init(){
 ...
 class creatListener implements ActionListener{
	runner runner;
	public creatListener(runner runner) {
