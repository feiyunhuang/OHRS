...
public class Odvo implements Serializable{
	...
	public OdListvo exchange(){
		OdListvo odlistvo = new OdListvo();
		odlistvo.setOdID(this.OdID);
		odlistvo.setOdStatus(this.OdStatus);
		odlistvo.setclientID(this.clientID);
		odlistvo.setkindOfRoom(this.kindOfRoom);
		odlistvo.setcomeTime(this.comeTime);
		odlistvo.setdays(this.days);
		return odlistvo;
	}
}
